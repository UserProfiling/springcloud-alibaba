...
![image-20220520112652439](.\J2EE课程记录.assets\image-20220520112652439.png)
...
![image-20220515205748683](.\J2EE课程记录.assets\image-20220515205748683.png)
...
![image-20220515205627307](.\J2EE课程记录.assets\image-20220515205627307.png)
...
![image-20220516102813153](.\J2EE课程记录.assets\image-20220516102813153.png)
...
![image-20220516104523933](.\J2EE课程记录.assets\image-20220516104523933.png)

编写配置累，要保证名字就是iRule，不要写错了

![image-20220516103812697](.\J2EE课程记录.assets\image-20220516103812697.png)

然后在application启动类上面添加RibbonClients注解，表明对那个服务提供方使用怎么样的负载均衡策略。

![image-20220516104659870](.\J2EE课程记录.assets\image-20220516104659870.png)

##### 2.配置文件方式

**注意在服务消费者这里要填写的是服务提供者的名字，如下面就是要写product-sevice**

![image-20220516140935761](.\J2EE课程记录.assets\image-20220516140935761.png)

将productApplication权重改为5之后，重新运行

![image-20220516141232288](.\J2EE课程记录.assets\image-20220516141232288.png)

用postman Runner 连续跑十次的结果如下：

![image-20220516141141849](.\J2EE课程记录.assets\image-20220516141141849.png)

##### 3.自定义策略

![image-20220516143209920](.\J2EE课程记录.assets\image-20220516143209920.png)

创建文件，然后实现AbstractLoadBalancerRule类，

重写choose方法，下面是自己实现的随机选择方法：

![image-20220516143244093](.\J2EE课程记录.assets\image-20220516143244093.png)

在配置文件中修改之后，重新run，测试后的结果如下：

![image-20220516143342860](.\J2EE课程记录.assets\image-20220516143342860.png)

![image-20220516143347932](.\J2EE课程记录.assets\image-20220516143347932.png)

##### 4.开启饥饿加载

为了解决第一次调用慢的问题

![image-20220516143638960](.\J2EE课程记录.assets\image-20220516143638960.png)

![image-20220516144207289](.\J2EE课程记录.assets\image-20220516144207289.png)

修改之后的运行结果如下，就没有了加载的情况：

![image-20220516144229385](.\J2EE课程记录.assets\image-20220516144229385.png)
...
![image-20220516152622984](.\J2EE课程记录.assets\image-20220516152622984.png)

3.调用端在启动类上添加@EnableFeignClients注解

![image-20220516152636754](.\J2EE课程记录.assets\image-20220516152636754.png)

4.发起调用，像调用本地方式一样调用远程服务

![image-20220516152704444](.\J2EE课程记录.assets\image-20220516152704444.png)
...
![image-20220516161025371](.\J2EE课程记录.assets\image-20220516161025371.png)
...
![image-20220516165057212](.\J2EE课程记录.assets\image-20220516165057212.png)

![image-20220516161221270](.\J2EE课程记录.assets\image-20220516161221270.png)

在application.yml文件中加上allow-bean-definition-overriding： true就可以了

以上代码可以使多个接口使用@FeignClient调用同一个服务

![image-20220516161546348](.\J2EE课程记录.assets\image-20220516161546348.png)
...
![image-20220516162322513](.\J2EE课程记录.assets\image-20220516162322513.png)日志的输出结果就是：

![image-20220516162300280](.\J2EE课程记录.assets\image-20220516162300280.png)
...
​		![image-20220516165405288](.\J2EE课程记录.assets\image-20220516165405288.png)

然后需要日志输出的Service上面添加configuration

![image-20220516165451034](.\J2EE课程记录.assets\image-20220516165451034.png)

​	2.配置文件形式

![image-20220516170039673](.\J2EE课程记录.assets\image-20220516170039673.png)
...
![image-20220516171607982](.\J2EE课程记录.assets\image-20220516171607982.png)
...
![image-20220516173040046](.\J2EE课程记录.assets\image-20220516173040046.png)
...
![image-20220516173240312](.\J2EE课程记录.assets\image-20220516173240312.png)
...
![image-20220516195929159](.\J2EE课程记录.assets\image-20220516195929159.png)
...
![image-20220516201051974](.\J2EE课程记录.assets\image-20220516201051974.png)
...
![image-20220516202801721](.\J2EE课程记录.assets\image-20220516202801721.png)

**注意1:如果开启了权限管理，就一定要在bootstrap.yml文件中加上用户名和密码**

![image-20220516205910153](.\J2EE课程记录.assets\image-20220516205910153.png)

否则就会报如下的错误：

![image-20220516205826538](.\J2EE课程记录.assets\image-20220516205826538.png)

#### 2.客户端使用（具体可以看官网）

**注意2：在配置文件中我们指明了application的name是nacos-config，如果此时在nacos配置中心中没有名为nacos-config的配置，此时就会输出电脑本地环境的用户名**

![image-20220516210241376](.\J2EE课程记录.assets\image-20220516210241376.png)

![image-20220516210523248](.\J2EE课程记录.assets\image-20220516210523248.png)

![image-20220516210835262](.\J2EE课程记录.assets\image-20220516210835262.png)
...
![image-20220516211735509](.\J2EE课程记录.assets\image-20220516211735509.png)

然后就会把最新的md5更新到数据库中

![image-20220516211842954](.\J2EE课程记录.assets\image-20220516211842954.png)
...
![image-20220517101649887](.\J2EE课程记录.assets\image-20220517101649887.png)
...
![image-20220517104255931](.\J2EE课程记录.assets\image-20220517104255931.png)

![image-20220517104416705](.\J2EE课程记录.assets\image-20220517104416705.png)
...
![image-20220517104926611](.\J2EE课程记录.assets\image-20220517104926611.png)
...
![image-20220517105818892](.\J2EE课程记录.assets\image-20220517105818892.png)

## Sentinel

**服务的可用性问题**

![image-20220517110344096](.\J2EE课程记录.assets\image-20220517110344096.png)
...
![image-20220517111123851](.\J2EE课程记录.assets\image-20220517111123851.png)
...
![image-20220517111230829](.\J2EE课程记录.assets\image-20220517111230829.png)

隔离后：

![image-20220517111344150](.\J2EE课程记录.assets\image-20220517111344150.png)

![image-20220517111352270](.\J2EE课程记录.assets\image-20220517111352270.png)
...
![image-20220517111857898](.\J2EE课程记录.assets\image-20220517111857898.png)
...
![image-20220517113118313](.\J2EE课程记录.assets\image-20220517113118313.png)
...
​	![image-20220517145108211](.\J2EE课程记录.assets\image-20220517145108211.png)

然后对相应的资源设置流控保护规则，当然保护规则无论是那种方法都是要写的，保护规则和被保护接口通过ResourceName连接在一起：

![image-20220517145136393](.\J2EE课程记录.assets\image-20220517145136393.png)
...
![image-20220517145926327](.\J2EE课程记录.assets\image-20220517145926327.png)
...
![image-20220517165808130](.\J2EE课程记录.assets\image-20220517165808130.png)

3.可以自定义一个统一的异常处理类

Result--返回结果的封装类

![image-20220517165840794](.\J2EE课程记录.assets\image-20220517165840794.png)

![image-20220517165937373](.\J2EE课程记录.assets\image-20220517165937373.png)
...
![image-20220517172441414](.\J2EE课程记录.assets\image-20220517172441414.png)
...
![image-20220517185148641](.\J2EE课程记录.assets\image-20220517185148641.png)

新建一个HTTP请求：

![image-20220517185411734](.\J2EE课程记录.assets\image-20220517185411734.png)
...
![image-20220517173530880](.\J2EE课程记录.assets\image-20220517173530880.png)

在controller层中，有两个接口test1和test2调用了它

![image-20220517173554735](.\J2EE课程记录.assets\image-20220517173554735.png)

调用树如下：

![image-20220517173932658](.\J2EE课程记录.assets\image-20220517173932658.png)

这时候我们只想限制**test1的访问**，就在控制台上添加**链路**规则

![image-20220517173834782](.\J2EE课程记录.assets\image-20220517173834782.png)
...
![image-20220517174310008](.\J2EE课程记录.assets\image-20220517174310008.png)

这个时候因为在getUser上使用了@SentinelResource注解，他就不会使用我们统一的异常处理类，那就只能自己写一个BlockHandler，

**注意不要忘记加 （BlockException e）   !!!!**

![image-20220517175129485](.\J2EE课程记录.assets\image-20220517175129485.png)
...
![image-20220517190751179](.\J2EE课程记录.assets\image-20220517190751179.png)

用jmeter测试结果后：

实时监控结果如下，可以看到通过QPS在逐渐地增加

![image-20220517190916110](.\J2EE课程记录.assets\image-20220517190916110.png)
...
![image-20220517192259180](.\J2EE课程记录.assets\image-20220517192259180.png)

2.添加一个固定定时器，每次循环之后等待5s

![image-20220517192344320](.\J2EE课程记录.assets\image-20220517192344320.png)

然后设置流控规则：

![image-20220517192438297](.\J2EE课程记录.assets\image-20220517192438297.png)

之后运行jmeter脚本就会有这样的效果：

![image-20220517192218107](.\J2EE课程记录.assets\image-20220517192218107.png)

###### 7.熔断降级与隔离

熔断一般都定义在消费者端， 主要是对弱依赖服务进行服务降级.

![image-20220518100741322](.\J2EE课程记录.assets\image-20220518100741322.png)
...
![image-20220518144555366](.\J2EE课程记录.assets\image-20220518144555366.png)

3.异常数

![image-20220518144619797](.\J2EE课程记录.assets\image-20220518144619797.png)
...
![image-20220518143930235](.\J2EE课程记录.assets\image-20220518143930235.png)
...
![image-20220518150029907](.\J2EE课程记录.assets\image-20220518150029907.png)
...
![image-20220518153057644](.\J2EE课程记录.assets\image-20220518153057644.png)
...
![image-20220518153307495](.\J2EE课程记录.assets\image-20220518153307495.png)
...
![image-20220518151150342](.\J2EE课程记录.assets\image-20220518151150342.png)
...
![image-20220518142450909](.\J2EE课程记录.assets\image-20220518142450909.png)
...
![image-20220518142535749](.\J2EE课程记录.assets\image-20220518142535749.png)
...
![image-20220518202424914](.\J2EE课程记录.assets\image-20220518202424914.png)
...
![image-20220518202924164](.\J2EE课程记录.assets\image-20220518202924164.png)

而二阶段如果是提交的话，因为“业务SQL”在一阶段已经提交至数据库，所以Seata框架只需将一阶段保存的快照数据和行锁删掉，完成数据清理即可。

![image-20220518202949489](.\J2EE课程记录.assets\image-20220518202949489.png)
...
![image-20220518203637786](.\J2EE课程记录.assets\image-20220518203637786.png)
...
![image-20220519140802890](.\J2EE课程记录.assets\image-20220519140802890.png)

![image-20220519140825802](.\J2EE课程记录.assets\image-20220519140825802.png)

2.创建seata数据库

在资源目录: https://github.com/seata/seata/tree/1.3.0/script/server/db中找到mysql.db然后运行

![image-20220519141005859](.\J2EE课程记录.assets\image-20220519141005859.png)

3.修改registry.conf中的配置

![image-20220519141616865](.\J2EE课程记录.assets\image-20220519141616865.png)

![image-20220519141634038](.\J2EE课程记录.assets\image-20220519141634038.png)

4.修改sctipt文件夹中的config.txt文件

![image-20220519142830898](.\J2EE课程记录.assets\image-20220519142830898.png)

将mode改为db

![image-20220519142903304](.\J2EE课程记录.assets\image-20220519142903304.png)

然后这个是配置事务分组，要与客户端配置的事务分组保持一致，其中my_test_tx_group可以自定义,

**Note 版本别下错了**

![image-20220519200941840](.\J2EE课程记录.assets\image-20220519200941840.png)

然后再gitbash中运行如下所示的文件，注意，在nacos-config.sh中要先添加nacos的用户名和密码：

![image-20220519143018249](.\J2EE课程记录.assets\image-20220519143018249.png)

![image-20220519142929834](.\J2EE课程记录.assets\image-20220519142929834.png)

5.然后就可以运行seata了

![image-20220519143058313](.\J2EE课程记录.assets\image-20220519143058313.png)
...
![image-20220519192913746](.\J2EE课程记录.assets\image-20220519192913746.png)
...
![image-20220519201524081](.\J2EE课程记录.assets\image-20220519201524081.png)

**下面这个是有问题的**

![image-20220519193007017](.\J2EE课程记录.assets\image-20220519193007017.png)
...
![image-20220519193643399](.\J2EE课程记录.assets\image-20220519193643399.png)

5.seata的运行原理图

![image-20220519202500340](.\J2EE课程记录.assets\image-20220519202500340.png)
...
![image-20220519203114937](.\J2EE课程记录.assets\image-20220519203114937.png)
...
![image-20220519203223156](.\J2EE课程记录.assets\image-20220519203223156.png)
...
![image-20220520113520632](.\J2EE课程记录.assets\image-20220520113520632.png)
...
![image-20220520161735877](.\J2EE课程记录.assets\image-20220520161735877.png)
...
![image-20220520162758590](.\J2EE课程记录.assets\image-20220520162758590.png)
...
![image-20220520164116787](.\J2EE课程记录.assets\image-20220520164116787.png)
...
![image-20220520172848614](.\J2EE课程记录.assets\image-20220520172848614.png)
...
![image-20220520172955028](.\J2EE课程记录.assets\image-20220520172955028.png)
...
![image-20220520180127664](.\J2EE课程记录.assets\image-20220520180127664.png)

上面就是通过全局过滤器输出的日志，下面就是Reactor netty输出的日志

![image-20220520180048370](.\J2EE课程记录.assets\image-20220520180048370.png)
...
![image-20220520203232837](.\J2EE课程记录.assets\image-20220520203232837.png)

网关api名称

![image-20220520203258720](.\J2EE课程记录.assets\image-20220520203320588.png)

流控规则截图：

![image-20220520203400693](.\J2EE课程记录.assets\image-20220520203400693.png)

也可以针对请求的特定属性进行限流，如果请求的参数符合设置的规则，就会对该请求进行限流：

![image-20220520203629900](.\J2EE课程记录.assets\image-20220520203629900.png)
...
![image-20220520212159947](.\J2EE课程记录.assets\image-20220520212159947.png)
...
![image-20220520212539618](.\J2EE课程记录.assets\image-20220520212539618.png)
...
![image-20220520213406705](.\J2EE课程记录.assets\image-20220520213406705.png)
...
![image-20220520213644954](.\J2EE课程记录.assets\image-20220520213644954.png)
...
![image-20220520214737969](.\J2EE课程记录.assets\image-20220520214737969.png)
...
![image-20220522121112959](.\J2EE课程记录.assets\image-20220522121112959.png)

**然后重启各个服务**，调用一下接口，就会显示getaway路径了

![image-20220522122118670](.\J2EE课程记录.assets\image-20220522122118670.png)
...
![image-20220522122257733](.\J2EE课程记录.assets\image-20220522122257733.png)
...
![image-20220522122531245](.\J2EE课程记录.assets\image-20220522122531245.png)

2.修改mysql配置，**需要手动去创建一下数据库**

![image-20220522122634991](.\J2EE课程记录.assets\image-20220522122634991.png)

保存之后重启一下，这时候会发现启动失败了，去查看日志文件，会发现出现了如下的错误：

![image-20220522142710423](.\J2EE课程记录.assets\image-20220522142710423.png)

![image-20220522142649326](.\J2EE课程记录.assets\image-20220522142649326.png)

原因是因为，skywalking的oap-libs的jar包中，没有mysql的驱动，去把项目中的mysql驱动复制一份到skywalking的oap-libs文件夹中即可

![image-20220522143052572](.\J2EE课程记录.assets\image-20220522143052572.png)

![image-20220522143122340](.\J2EE课程记录.assets\image-20220522143122340.png)
...
![image-20220522145936764](.\J2EE课程记录.assets\image-20220522145936764.png)
...
![image-20220522152025773](.\J2EE课程记录.assets\image-20220522152025773.png)

这里会发现，红色框中出现的并不是我们想要看到的返回值，而是一串神秘数字，这时候。我们需要在Order实体类中添加ToString方法，然后重新运行服务

![image-20220522152830937](.\J2EE课程记录.assets\image-20220522152830937.png)

![image-20220522152907193](.\J2EE课程记录.assets\image-20220522152907193.png)
...
![image-20220522153251644](.\J2EE课程记录.assets\image-20220522153251644.png)
...
![image-20220522161110865](.\J2EE课程记录.assets\image-20220522161110865.png)
...
![image-20220522161615361](.\J2EE课程记录.assets\image-20220522161615361.png)

然后就可以在控制台上看到时间，如果点击搜索发现为空，就改一下时间范围。

![image-20220522161557901](.\J2EE课程记录.assets\image-20220522161557901.png)



如果sky walking没有部署在本地，要修改一下如下的配置文件

![image-20220522162000399](.\J2EE课程记录.assets\image-20220522162000399.png)
...
![image-20220522162015297](.\J2EE课程记录.assets\image-20220522162015297.png)
...
![image-20220522165609833](.\J2EE课程记录.assets\image-20220522165609833.png)

2.在gateway项目中添加实体类和接口

![image-20220522165440953](.\J2EE课程记录.assets\image-20220522165440953.png)
...
![image-20220522171249920](.\J2EE课程记录.assets\image-20220522171249920.png)

![image-20220522165625172](.\J2EE课程记录.assets\image-20220522165625172.png)
...
![image-20220522170053639](.\J2EE课程记录.assets\image-20220522170053639.png)

2.修改nacos配置

![image-20220522170116819](.\J2EE课程记录.assets\image-20220522170116819.png)

可以选择性的修改监听端口和存储策略

![image-20220522170339186](.\J2EE课程记录.assets\image-20220522170339186.png)

![image-20220522170353629](.\J2EE课程记录.assets\image-20220522170353629.png)

![image-20220522170447290](.\J2EE课程记录.assets\image-20220522170447290.png)

2.配置UI服务webapp.yml文件的listOfservers,写两个不同的oap地址地址

![image-20220522170428172](.\J2EE课程记录.assets\image-20220522170428172.png)
